...
// proof
const unsigned char BYTES_PROOF_A[32] = {63, 181, 189, 240, 109, 212, 63, 0, 116, 37, 203, 242, 206, 192, 89, 223, 12, 20, 218, 168, 72, 180, 207, 205, 55, 70, 66, 210, 54, 98, 22, 34};
const unsigned char BYTES_PROOF_B[64] = {192, 52, 152, 99, 148, 181, 232, 215, 42, 207, 70, 50, 222, 97, 187, 242, 217, 243, 86, 186, 18, 105, 217, 253, 178, 38, 131, 170, 141, 47, 119, 142, 67, 4, 66, 83, 243, 108, 138, 174, 187, 10, 92, 7, 39, 164, 149, 146, 70, 240, 223, 94, 184, 61, 102, 106, 79, 190, 235, 151, 0, 110, 14, 4};
const unsigned char BYTES_PROOF_C[32] = {233, 177, 185, 48, 160, 27, 31, 118, 47, 61, 158, 110, 6, 128, 246, 232, 229, 26, 93, 50, 172, 232, 126, 43, 71, 81, 48, 218, 215, 155, 14, 29};

// journal
const unsigned char JOURNAL[] = {19, 9, 0, 0, 0, 0, 0, 0};
